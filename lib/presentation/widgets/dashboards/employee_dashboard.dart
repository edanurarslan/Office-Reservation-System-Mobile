...
import '../common/reservation_create_form.dart';
...
class _EmployeeDashboardState extends State<EmployeeDashboard> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(
          'Hoş Geldiniz, ${widget.user.firstName}!',
          ...
          children: [
            ...
            GestureDetector(
              onTap: () => ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('QR scanner özelliği yakında gelecek')),
              ),
              child: _buildActionButton(
                'QR ile Giriş Yap',
                Icons.qr_code_scanner,
